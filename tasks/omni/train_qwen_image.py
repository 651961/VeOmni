...
from veomni.models.transformers.qwen_image import QwenImageModel
    ...
    for epoch in range(start_epoch, args.train.num_train_epochs):
        ...
        for _ in range(args.train.train_steps):
            ...
            for batch in micro_batches:
                ...
                height = batch["image"].size[1]
                width = batch["image"].size[2]
                # TODO
                ...
                # TODO: prompt_emb_mask
                # TODO: qwen image( func_image(image, func_text(text)))
                # 1. func_text(text)
                # 2. func_image(image, func_text())
                # 3.
