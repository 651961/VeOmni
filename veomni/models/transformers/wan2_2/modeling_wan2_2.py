...
class WanModel2_2(PreTrainedModel):
    ...
    def __init__(self, config: WanConfig2_2, **kwargs):
...
if is_liger_kernel_available():
    ...
    logger.info_rank0("Apply liger kernel to Wan2_2.")

if is_torch_npu_available() and is_transformers_version_greater_or_equal_to("4.50.4"):
    from .npu_patch import apply_wan2_2_npu_patch

    apply_wan2_2_npu_patch()

try:
    from veomni.ops.dit.rope_wan.rotary import apply_rotary_emb

    rope_apply = apply_rotary_emb
    logger.info_rank0("Apply fused interleaved rope to Wan2_2.")
except ImportError:
    pass
