...
def apply_wan2_2_npu_patch():
    # Patches for wan2.2 Model
    modeling_wan2_2.RMSNorm.forward = rms_norm_forward_npu
    modeling_wan2_2.rope_apply = rope_apply_fused
